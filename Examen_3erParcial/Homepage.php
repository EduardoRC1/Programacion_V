...
<body>
    ...
    <a href="change_grade.php" class="btn">Cambiar Calificación</a><br>
    <h3>¿Te gustaría agregar una clase?</h3>
    <!-- Enlace para agregar una clase -->
    <a href="add_class.php" class="btn">Agregar Clase</a><br>

    <a href="boleta.php" class="btn">Ver Boleta de Calificaciones</a><br>
